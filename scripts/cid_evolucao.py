...
def infer_cid_suggestion(text: str) -> tuple[str, str]:
    ...
    rules: tuple[tuple[tuple[str, ...], str, str], ...] = (
        ...
        (("dor de dificil controle", "controle da dor"), "R52.9", "dor não especificada"),
        (("farmacodermia", "eritema multiforme"), "L51.9", "eritema multiforme/farmacodermia"),
        (("cancer de mama metastatico", "neoplasia de mama metastatica", "cine mama", "recidiva ossea e linfonodal"), "C50.9", "neoplasia maligna da mama"),
        ...
        (("lesao retal distal", "lesão retal distal", "neoplasia retal", "neoplasia de reto"), "C20", "neoplasia maligna do reto"),
        (("prolapso hemorroidario", "hemorroidectomia"), "K64.8", "outras hemorróidas especificadas"),
        ...
        (("alteracao de habito intestinal", "alteracao do habito intestinal", "alteracao habito intestinal", "alt. habito intestinal"), "R19.4", "alteração do hábito intestinal"),
        ...
        (("fratura do extremo distal do radio", "fratura distal do radio", "fratura intraarticular com desvio dorsal do radio distal", "fx de raio distal"), "S52.5", "fratura da extremidade distal do rádio"),
        (("fratura de radio e ulna",), "S52.9", "fratura do antebraço, parte não especificada"),
        ...
        (("lombalgia cronica", "ciatalgia intensa", "lombociatalgia"), "M54.4", "lumbago com ciática"),
        ...
        (("hernia encarcerada", "hernia umbilical com infeccao", "hernia umbilical com infecção"), "K42.0", "hérnia umbilical com obstrução, sem gangrena"),
        ...
        (("tpsv", "taquicardia supraventricular"), "I47.1", "taquicardia supraventricular"),
        ...
        (("sinusite aguda", "sinusite bacteriana"), "J01", "sinusite aguda"),
        ...
        (("neoplasia de ovario", "carcinoma seroso de ovario", "carcinoma seroso de ovário", "neoplasia maligna do ovario"), "C56", "neoplasia maligna do ovário"),
        ...
        (("intoxicacao exogena", "intoxicação exógena", "abuso de benzodiazepinicos", "abuso de benzodiazepínicos"), "T42.4", "intoxicação por benzodiazepínicos"),
        (("ureterolitotripsia", "nefrolitotripsia", "duplo j"), "N20.1", "cálculo do ureter"),
        (("cistostomia por puncao", "cistostomia por punção", "retencao urinaria", "retenção urinária"), "R33", "retenção urinária"),
        ...
        (("sintomas gripais", "quadro gripal", "congestao nasal", "coriza"), "J06.9", "infecção aguda de vias aéreas superiores"),
        ...
        (("oclusao arterial aguda do mid", "oclusão arterial aguda do mid"), "I74.3", "oclusão arterial aguda de membro inferior"),
        (("fratura de 7-10", "arcos costais", "gradil costal"), "S22.4", "fraturas múltiplas de costelas"),
        (("tromboflebite aguda", "tromboflebite subaguda", "veia cefalica", "veia cefálica"), "I80.8", "tromboflebite de outros sítios"),
        ...
        (("distensao abdominal", "distensão abdominal"), "R14", "flatulência e afecções correlatas"),
        (("constipacao cronica", "constipação crônica"), "K59", "outros transtornos funcionais do intestino"),
        (("ferimento profundo no tornozelo", "ferimento profundo em tornozelo"), "S91", "ferimento do tornozelo e do pé"),
        (("hematoma pos-traumatico", "hematoma pós-traumático"), "S80", "traumatismo superficial da perna"),
        (("abscesso de face odontogenico", "abscesso de face odontogênico"), "K04.7", "abscesso periapical"),
        (("colite estercoral",), "K52", "outras gastroenterites e colites não-infecciosas"),
        (("abscesso periamigdaliano", "abscesso peritonsilar"), "J36", "abscesso periamigdaliano"),
        (("tumor pediculado de pele", "tumor superficial"), "D48.5", "neoplasia de comportamento incerto da pele"),
        ...
        (("cefaleia de dificil controle", "cefaleia de difícil controle"), "R51", "cefaleia"),
        (("espondilolistese",), "M43.1", "espondilolistese"),
        (("hematoma subdural",), "S06.5", "hemorragia subdural devida a traumatismo"),
        (("sarcoma indiferenciado de coxa", "sarcoma desdiferenciado em coxa"), "C49.2", "neoplasia maligna de tecidos moles de membro inferior"),
